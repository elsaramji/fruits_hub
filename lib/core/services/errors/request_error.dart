...
class RequestError {
  ...
  factory RequestError.fromDioException(DioException e) {
    switch (e.type) {
      case DioExceptionType.connectionTimeout:
        return RequestError(message: e.message ?? 'Connection timeout');
      case DioExceptionType.sendTimeout:
        return RequestError(message: e.message ?? 'Send timeout');
      case DioExceptionType.receiveTimeout:
        return RequestError(message: e.message ?? 'Receive timeout');
      case DioExceptionType.badCertificate:
        return RequestError(message: e.message ?? 'Bad certificate');
      case DioExceptionType.badResponse:
        return RequestError(message: e.message ?? 'Bad response');
      case DioExceptionType.cancel:
        return RequestError(message: e.message ?? 'Request cancelled');
      case DioExceptionType.connectionError:
        return RequestError(message: e.message ?? 'Connection error');
      case DioExceptionType.unknown:
        return RequestError(message: e.message ?? 'Unknown error');
    }
  }
}
